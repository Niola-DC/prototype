...
// import about from '../../../public/videos/whyPayskul.mp4';
import about from './videos/whyPayskul.mp4';
// import about from '../../../public/slider.mp4';
...
const PlatformSection = () => {
  ...
  return (
    <div className="bg-purple-200 rounded-lg w-full max-w-screen mx-auto h-full">
      <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-12 items-center py-14 pt-20 px-3 lg:pt-28 md:px-10 lg:px-18">
        ...
        <div className="order-2 lg:order-1">
          ...
          <div className="space-y-3">
            <p className="lg:max-w-5/6 text-sm text-black font-medium text-center lg:text-left py-4">
            ...
            <div className="mt-0 lg:mt-18 lg:pt-18 pt-8 flex flex-col items-center space-y-2 lg:flex-row lg:space-x-4 lg:space-y-0 justify-center lg:justify-start">
              <Typography variant="caption" className="text-center lg:text-left text-base mt-0">
      ...
      {/* <VideoBox src={about} poster="About Payskul" controls /> */}
              <VideoBox src='https://payskul-slider.s3.us-east-1.amazonaws.com/whyPayskul.mp4' poster="Motion" controls />
      

      {/* <VideoBox src='../../../public/videos/whyPayskul.mp4' poster="About Payskul" /> */}
    </div>
  );
};
