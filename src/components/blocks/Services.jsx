...
import eduPayImg from "../../assets/images/credit.jpg";
import skulMartImg from "../../assets/images/mart.jpg";
import skolarImg from "../../assets/images/skolr.jpg";
import skulFindImg from "../../assets/images/location.jpg";
...
const Services = () => {
  const services = [
    {
      ...
      title: "EduPay",
      description:
        "We provide flexible and transparent education loans to help you achieve your goals without financial worry.",
      image: eduPayImg,
    },
    {
      id: "skulMart",
      title: "SkulMart",
      description:
        "Your one-stop shop for school essentials, ensuring students have all they need to excel.",
      image: skulMartImg,
    },
    {
      id: "skolar",
      title: "Skolar",
      description:
        "A scholarship platform that connects students with financial aid opportunities worldwide.",
      image: skolarImg,
    },
    {
      id: "skulFind",
      title: "SkulFind",
      description:
        "Helping students discover the best institutions and educational opportunities suited for them.",
      image: skulFindImg,
    },
  ];
  ...
  return (
    <div id="features" className="bg-white w-full max-w-6xl mx-auto px-4 py-10">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-2">Our Services</h2>
        <p className="text-gray-700 max-w-2xl mx-auto text-sm">
          At PaySkul, we empower your education and future. <br /> Download the
          app to school with ease.
        </p>
      </div>
        ...
        <div className="w-full md:flex md:flex-row md:justify-center md:gap-6">
          ...
          <div className="flex flex-col gap-4">
            {services.slice(0, 2).map((service) => (
              <div
                key={service.id}
                className={`p-6 w-80 rounded-lg shadow-lg cursor-pointer transition-all ${
          ...
          <div>
            <img
              className="h-fit w-[560px] object-cover transition-opacity duration-300"
              src={activeImage}
              alt="Service preview"
            />
          </div>
      ...
      {/* Mobile View */}
      <div className="md:flex flex flex-col items-center lg:hidden mb:mb-10">
        ...
        <div
          ...
          className="w-full overflow-x-auto pb-4 flex gap-4 snap-x"
        >
          <div className="flex gap-4 min-w-max">
            ...
            <div
              ref={scrollContainerRef}
              className="w-full h-[410px] overflow-x-auto pb-4 flex gap-6 snap-x snap-mandatory mb-8"
            >
              <div className="flex gap-6 min-w-max mb-10 pb-10">
                {services.map((service, index) => (
                  <div
                    key={service.id}
                    className="w-[270px] flex flex-col items-center text-center cursor-pointer snap-start mb-8 pb-8"
                  >
                    {/* Alternating Layout */}
                    {index % 2 !== 0 && (
                      <div className=" p-6 w-[270px] shadow-lg cursor-pointer mt-4">
                    ...
                    <div className="w-[270px] h-[300px] bg-purple-100 flex justify-center items-center p-4">
                      <img
                    ...
                    {index % 2 === 0 && (
                      <div className=" p-6 w-[270px] rounded-lg shadow-lg cursor-pointer">
                        <div className="w-6 h-6 bg-purple-200 rounded-full mb-2 mx-auto"></div>
                        <h3 className="text-base font-semibold mb-1">
                          {service.title}
                        </h3>
