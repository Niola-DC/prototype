    ...
    <div className="bg-purple-100 rounded-lg  mx-auto h-full flex justify-center">
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center h-full ">
        ...
        <div className="lg:order-2">
          ...
          <div className='mt-18'>
          <p className="text-base text-gray-500 text-center mb-6 lg:text-center lg:w-lg mx-12 lg:mx-2">
            ...
            {/* <p className="text-base text-gray-500 text-center mb-6 lg:text-center lg:w-lg lg:hidden">
              Can't find the answer you're looking for? <br/><a href="contact" className="text-purple-600 font-medium">Click here</a> to reach out to us.
            </p> */}
          </div>
        </div>
      </div>
