...
import photo from '../../assets/images/plann.png';
import VideoBox from '../composite/VieBox';
// import slider from '../../../public/videos/slider.mp4';
import slider from './videos/slider.mp4';
...
const EduPlanningSection = () => {
  ...
  return (
    <section className="py-6 pb-0 bg-white flex flex-col items-center text-center">
      ...
      <div className='w-full lg:mt-4 sm:mb-2 sm:mt-2 sm:pt-0'>
      {/* <video
        ref={videoRef}
      ...
      {/* /> */}
        ...
        {/* <video src="/videos/slider.mp4" controls></video> */}

        {/* <VideoBox src= {slider} poster="Motion" /> */}
        {/* <VideoBox src='/public/videos/slider.mp4' poster='Motion' controls /> */}
        {/* <VideoBox src={slider} poster="Motion" /> */}
        <VideoBox src='https://payskul-slider.s3.us-east-1.amazonaws.com/slider.mp4' poster="Motion" />
