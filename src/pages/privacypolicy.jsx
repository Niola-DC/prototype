...
const PrivacyPolicyPage = () => {
  ...
  return (
    ...
    <div className="bg-white p-4 sm:p-8 rounded-lg max-w-4xl mx-auto w-full md:w-3/4">
      ...
      {/* <div className="bg-white p-4 sm:p-8 rounded-lg max-w-4xl mx-auto w-full md:w-3/4 lg:w-2/3"> */}
        <Heading variant='head'>Privacy Policy</Heading>
        <h2 className="text-3xl sm:text-3xl md:text-4xl font-bold text-purple-800 mb-4 sm:mb-6 text-left mx-14">Your Privacy is Our Priority</h2>

        <p className="my-4 text-lg text-gray-600 max-w-3xl mx-auto">
